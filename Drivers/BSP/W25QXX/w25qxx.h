...
#define W25Qx_Enable() 			HAL_GPIO_WritePin(FSPI_CS_GPIO_Port, FSPI_CS_Pin, GPIO_PIN_RESET)
#define W25Qx_Disable() 		HAL_GPIO_WritePin(FSPI_CS_GPIO_Port, FSPI_CS_Pin, GPIO_PIN_SET)
