...
C_SRCS += \
../Middlewares/Third_Party/lwip/contrib/ports/cmsis/OS/sys_arch.c 

OBJS += \
./Middlewares/Third_Party/lwip/contrib/ports/cmsis/OS/sys_arch.o 

C_DEPS += \
./Middlewares/Third_Party/lwip/contrib/ports/cmsis/OS/sys_arch.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/Third_Party/lwip/contrib/ports/cmsis/OS/%.o Middlewares/Third_Party/lwip/contrib/ports/cmsis/OS/%.su Middlewares/Third_Party/lwip/contrib/ports/cmsis/OS/%.cyclo: ../Middlewares/Third_Party/lwip/contrib/ports/cmsis/OS/%.c Middlewares/Third_Party/lwip/contrib/ports/cmsis/OS/subdir.mk
...
clean: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-ports-2f-cmsis-2f-OS

clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-ports-2f-cmsis-2f-OS:
	-$(RM) ./Middlewares/Third_Party/lwip/contrib/ports/cmsis/OS/sys_arch.cyclo ./Middlewares/Third_Party/lwip/contrib/ports/cmsis/OS/sys_arch.d ./Middlewares/Third_Party/lwip/contrib/ports/cmsis/OS/sys_arch.o ./Middlewares/Third_Party/lwip/contrib/ports/cmsis/OS/sys_arch.su

.PHONY: clean-Middlewares-2f-Third_Party-2f-lwip-2f-contrib-2f-ports-2f-cmsis-2f-OS
