...
C_SRCS += \
../Core/lwip/ping/ping_cmd.c 

OBJS += \
./Core/lwip/ping/ping_cmd.o 

C_DEPS += \
./Core/lwip/ping/ping_cmd.d 


# Each subdirectory must supply rules for building sources it contributes
Core/lwip/ping/%.o Core/lwip/ping/%.su Core/lwip/ping/%.cyclo: ../Core/lwip/ping/%.c Core/lwip/ping/subdir.mk
...
clean: clean-Core-2f-lwip-2f-ping

clean-Core-2f-lwip-2f-ping:
	-$(RM) ./Core/lwip/ping/ping_cmd.cyclo ./Core/lwip/ping/ping_cmd.d ./Core/lwip/ping/ping_cmd.o ./Core/lwip/ping/ping_cmd.su

.PHONY: clean-Core-2f-lwip-2f-ping
